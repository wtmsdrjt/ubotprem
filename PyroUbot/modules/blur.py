...
**Perintah:**
- **{0}blur**
    - Digunakan untuk memburamkan gambar.

**Penjelasan:**
- Gunakan perintah **{0}blur** untuk memburamkan gambar sesuai kebutuhan Anda. Ini dapat membantu menciptakan efek visual yang menarik atau melindungi informasi sensitif dalam gambar.
"""
...
async def blur_cmd(client, message):
    ...
    if not ureply:
        return await xd.edit("❌ Mohon balas gambarnya.")
