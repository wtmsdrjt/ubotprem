...
__HELP__ = """
**Bantuan Untuk Instagram**

**Perintah:**
- **{0}ig [link]**
    - Digunakan untuk mendownload video dari Instagram.

**Penjelasan:**
- Gunakan perintah **{0}ig [link]** untuk mengunduh video dari Instagram dengan menggunakan link yang sesuai. Ini memudahkan Anda untuk menyimpan konten video yang Anda sukai.
"""
...
async def instacrot(client: Client, message):
    ...
    if len(message.text.split()) < 2:
        await message.reply_text("Gunakan perintah .ig [url] untuk mengunduh konten dari Instagram.")
        return

    link = message.text.split()[1]
    try:
        m = await message.reply_text("Sedang diproses...")
        ...
        try:
            ...
            await message.reply_text(
                "Maaf, tidak dapat menemukan hasil yang dimaksud. Silakan coba lagi atau laporkan ke @iamcheating"
            )
        finally:
            await m.delete()
