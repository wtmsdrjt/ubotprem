...
__MODULE__ = "ᴋᴏɴᴛᴀᴋ"
__HELP__ = """
**Bantuan Untuk Kontak**

**Perintah:**
- **{0}savekon** [reply to user - ID/username] [nama kontak]  
    **Penjelasan:** Untuk menyimpan kontak di Telegram. Gunakan perintah ini untuk menyimpan informasi kontak dari pengguna yang Anda balas, dengan memberikan nama yang diinginkan untuk kontak tersebut.

- **{0}delkon** [reply to user - ID/username]  
    **Penjelasan:** Untuk menghapus kontak yang disimpan di Telegram. Dengan perintah ini, Anda dapat menghapus informasi kontak dari pengguna yang Anda balas.
"""
