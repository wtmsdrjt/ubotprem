...
__MODULE__ = "sᴘᴏᴛɪғʏ"
__HELP__ = """
**Bantuan Untuk Spotify**

**Perintah:**
- **{0}spotify judul lagu**  
  **Penjelasan:** Mendownload music yang diinginkan.
"""
...
async def spotify_search(client, message):
    ...
    if not query:
        await message.reply_text("Contoh : .spotify Iloveuihateu")
        return
    
    proses_msg = await message.reply_text("<emoji id=4967797089971995307>🔍</emoji> Sedang diproses...")
    search_url = f"https://api.botcahx.eu.org/api/search/spotify?query={query}&apikey=Boyy"
