...
**Penjelasan:**
- Gunakan perintah ini untuk mencari ayat tertentu dalam Al Qur'an dengan menyebutkan nomor surah dan ayat. Gantilah angka "1" dengan nomor surah yang diinginkan dan "2" dengan nomor ayat yang ingin dicari.
"""
...
async def send_quran(client, message):
    try:
        ...
        if len(args) < 2 or not args[0].isdigit() or not args[1].isdigit():
            await message.reply_text("**Contoh:**\n- Anda dapat mengetik: `.alquran 1 2`\nHasilnya akan menunjukkan Surah Al-Fatihah Ayat 2.")
            return
